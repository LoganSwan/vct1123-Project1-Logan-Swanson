...
for (var i = 0;i<4; i++){
    ...
    for (var i = 0;i<sections.length; i++){
        ...
        "artistList += <tr>Artist Album<td>Album:</td><td>" + allArtists[i].album + "</td></tr>"
        "artistList += <tr>Artist Label<td>Label:</td><td>" + allArtists[i].label + "</td></tr>"
        "artistList += <tr>Release Year<td>Year:</td><td>" + allArtists[i].year + "</td></tr>"
        artistList += "</table>";
